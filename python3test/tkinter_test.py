...
Entry(frame,textvariable=v2,width=30,validate="focusout",\
			validatecommand=(testCMD,'%P')).grid(row=2,column=0)
...
Button(frame,text="开始排序",command=calc).grid(row=1,column=0,pady=5)
